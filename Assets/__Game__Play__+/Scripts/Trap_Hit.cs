...
using Spine;
using DG.Tweening;
public class Trap_Hit : MonoBehaviour
{
    public int health;
    //
    [Header("Animation")]
    ...
    void Start()
    {
        ...
        {
            GetComponentInParent<Point_In_Floor>().Set_trap_Hit_Attach(this);
    ...
    {
        GameObject obj = (GameObject)Instantiate(Resources.Load(Constant.Path_Frefab_Health_Bar_Red), tf_TrapHit);
